#
#  Be sure to run `pod spec lint UITableViewSnapshot.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.name         = "UITableViewSnapshot"
  s.version      = "1.0.0"
  s.summary      = "ZFTableViewSnapshot - 类似于高德地图路线截取tableView长图的功能"
  s.description  = "类似于高德地图路线截取tableView长图的功能
...
3.调用[self.tableView screenshot]即可方法获取整个tableView长图，返回对象为UIImage类型。"
  ...
  s.homepage     = "https://github.com/ZFBest/UITableViewSnapshot.git"
  s.screenshots  = "https://github.com/ZFBest/UITableViewSnapshot/blob/master/IMG_2047.JPG"
  ...
  # ――― Source Code ―――――――――――――――――――――――――――――――――――――――――――――――――――――――――――――― #
  s.source_files  = "UITableViewSnapshot", "./UITableViewSnapshot/*.{h,m}"
